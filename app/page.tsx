...
const faqs = [
  ...
  { q: "Наиситна ли е безплатно или има някаква уловка?", a: "Да, наистина безплатно. В края накратко споменавам какво предлагаме за хората, които искат hands-on помощ но самото обучение е завършено само по себе си. Повечето хора го прилагат, без изобщо да купят нещо." },
