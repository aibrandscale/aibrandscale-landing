...
const oldWay = [
  ...
  "6–12 месеца преди да видиш първия си долар, ако изобщо стигнеш дотам",
...
const discover = [
  {
    ...
    desc: "Защо 19-годишен човек с правилните prompts вече може да побеждава агенции, които таксуват $10,000/месец, и как точно да се позиционираш в тази празнина, преди останалият свят да навакса.",
    long: true,
  },
  {
    n: "02",
  ...
  return (
    <section id="home" className="relative pt-16 pb-12 overflow-hidden">
      ...
      <div className="relative max-w-[1280px] mx-auto px-6 text-center">
        ...
        >
          Ако вече си пробвал dropshipping, Amazon или SMM агенция и си уморен от „онлайн бизнес“ гурута, които никога не показват реални резултати,{" "}
        ...
        <motion.div initial="hidden" animate="show" variants={fadeUp} custom={5} className="mt-12 flex flex-col items-center gap-7">
          ...
          <div style={{ width: "min(100%, 880px)", display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
            ...
            >
              Вземи безплатното обучение и виж как в действителност се влиза в тази индустрия. След това ще можеш сам да решиш дали това е за теб.
            </p>
          </div>
        </motion.div>
        )}
          ...
          <div className="grid lg:grid-cols-[420px_1fr]">
            ...
            <div className="p-10 md:p-12 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-2.5">
                {["€2.4M+ управлявани реклами", "60+ обучени студенти", "Активен оператор, не „гуру“"].map((t) => (
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-6">
          ...
          <h2 style={{ margin: 0, fontFamily: "alfabet, sans-serif", fontWeight: 800, fontSize: "clamp(22px, 2.4vw, 32px)", letterSpacing: "-0.02em", color: DC.fg, lineHeight: 1.2, textWrap: "balance", maxWidth: 820 }}>
            След 2 години AI ще управлява половината реклами по света. Въпросът е дали <em style={{ fontStyle: "italic", color: DC.purple200 }}>ти</em> ще ги управляваш — или ще плащаш за тях.
          </h2>
